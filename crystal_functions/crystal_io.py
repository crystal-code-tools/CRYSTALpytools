...
class Crystal_input:
    ...
    def from_blocks(self, geom_block, bs_block, func_block, scf_block, title='Input generated by CRYSTALpy'):
    ...
    def print_input(self):
        ...
        if len(self.__dict__) > 0:
            ...
            if self.title is not None:
                ...
                print('CRYSTALpy generated input')
            for block in blocks:
                for line in block:
                    if type(line) == list:
                        print(line[0][:-1])
    ...
    # external_obj is the ASE or pymatgen object that is going to be written in the gui file
        ...
        from CRYSTALpy.convert import cry_pmg2gui
        ...
        if self.title is None:
            title = ['Input generated using CRYSTALpy\n']
        else:
            title = self.title
