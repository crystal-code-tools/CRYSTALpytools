...
def plot_vecfield2D_m(header, dens, colormapdens, quivscale, name, dpi=400):
    ...
    Args:
        ...
        colormapdens (_type_): _description_
        quivscale (_type_): _description_
...
def plot_vecfield2D_J(header, dens_JX, dens_JY, dens_JZ, colormapdens, quivscale, name, dpi=400):
    ...
    Args:
        header (_type_): _description_
        dens_JX (_type_): _description_
        dens_JY (_type_): _description_
        dens_JZ (_type_): _description_
        colormapdens (_type_): _description_
        quivscale (_type_): _description_
        name (_type_): _description_
        dpi (int, optional): _description_. Defaults to 400.
...
def plot_cry_bands(bands, k_labels=None, energy_range=None, title=False, not_scaled=False, save_to_file=False, mode='single', linestl='-',
                   ...
                   sharex=True, sharey=True, dpi=None):
    ...
    if (mode == modes[0]) or (mode == modes[1]) or (mode == modes[3]):
        ...
        if mode == modes[3]:
            print('Warning, the surface bands are not ready yet')
            sys.exit(0)
    ...
    if save_to_file != False:
        save_plot(save_to_file, dpi=dpi)
...
def plot_cry_doss(doss, color='blue', fermi: str = 'forestgreen', save_to_file=False, overlap: bool = False, labels=None, figsize=None, linestl=None,
                  linewidth=1, title: str = None, beta: str = 'up', energy_range=None, dos_range=None, prj: list = None, dpi=None):
    """
    This function is meant to produce a Density of States (DOS) Plot starting from a doss object generated by the read_cry_doss() function 

    Args:
        doss (doss object): Object containing all of the information necessary for the DOS Plot
        color (str, optional): DOS color used for the plot. Defaults to 'blue'.
        fermi (str, optional): Fermi level color used in the plot. Defaults to 'forestgreen'.
        save_to_file (bool, optional): Saving option. Defaults to False.
        ...
        linestl ([type], optional): [description]. Defaults to None.
        linewidth (int, optional): [description]. Defaults to 1.
        title (str, optional): [description]. Defaults to None.
        beta (str, optional): [description]. Defaults to 'up'.
        energy_range ([type], optional): [description]. Defaults to None.
        dos_range ([type], optional): [description]. Defaults to None.
        prj (list, optional): [description]. Defaults to None.
        dpi ([type], optional): [description]. Defaults to None.
    """
...
def plot_cry_es(bands, doss, k_labels: list = None, save_to_file=False, color_bd='blue', color_doss='blue', fermi='forestgreen', energy_range: list = None, linestl_bd='-',
                linestl_doss=None, linewidth=1, prj: list = None, figsize=None, labels: list = None, dos_max_range: float = None, dpi=None):
    """

    Args:
        bands ([type]): [description]
        doss ([type]): [description]
        k_labels (list, optional): [description]. Defaults to None.
        save_to_file (bool, optional): [description]. Defaults to False.
        color_bd (str, optional): [description]. Defaults to 'blue'.
        color_doss (str, optional): [description]. Defaults to 'blue'.
        fermi (str, optional): [description]. Defaults to 'forestgreen'.
        energy_range (list, optional): [description]. Defaults to None.
        linestl_bd (str, optional): [description]. Defaults to '-'.
        linestl_doss ([type], optional): [description]. Defaults to None.
        linewidth (int, optional): [description]. Defaults to 1.
        prj (list, optional): [description]. Defaults to None.
        figsize ([type], optional): [description]. Defaults to None.
        labels (list, optional): [description]. Defaults to None.
        dos_max_range (float, optional): [description]. Defaults to None.
        dpi ([type], optional): [description]. Defaults to None.
    """
...
def plot_cry_contour(contour_obj, save_to_file=False):
    ...
    Args:
        contour_obj (_type_): _description_
...
def plot_cry_contour_differences(contour_obj, contour_obj_ref, save_to_file=False):
    ...
    Args:
        contour_obj ([type]): [description]
        contour_obj_ref ([type]): [description]
        save_to_file (bool, optional): [description]. Defaults to False.
    """
...
def plot_cry_rholine(rholine_obj, save_to_file=False):
    ...
    Args:
        rholine_obj (_type_): _description_
        save_to_file (bool, optional): _description_. Defaults to False.
    """
...
def plot_cry_sigma_carrier(sigma_obj, save_to_file=False):
    ...
    Args:
        sigma_obj (_type_): _description_
        save_to_file (bool, optional): _description_. Defaults to False.
    """
...
def plot_cry_powerfactor_potential(seebeck_obj, sigma_obj, save_to_file=False):
    ...
    Args:
        seebeck_obj (_type_): _description_
        sigma_obj (_type_): _description_
        save_to_file (bool, optional): _description_. Defaults to False.
    """
...
def plot_cry_shear(theta_1D, phi_1D, S, ndeg, shear_choice):
    ...
    Args:
        theta_1D (_type_): _description_
        phi_1D (_type_): _description_
        S (_type_): _description_
        ndeg (_type_): _description_
        shear_choice (_type_): _description_
...
def plot_cry_poisson(theta_1D, phi_1D, S, ndeg, poisson_choice):
    ...
    Args:
        ...
        S (_type_): _description_
        ndeg (_type_): _description_
        poisson_choice (_type_): _description_
...
def plot_cry_ela(choose, ndeg, *args, dpi=200, filetype=".png",
    ...
    Args:
        choose (_type_): _description_
        ndeg (_type_): _description_
        dpi (int, optional): _description_. Defaults to 200.
        filetype (str, optional): _description_. Defaults to ".png".
        transparency (bool, optional): _description_. Defaults to False.
    """
...
def save_plot(path_to_file, dpi=None):
    """_summary_

    Args:
        path_to_file (_type_): _description_
        dpi (_type_, optional): _description_. Defaults to None.
    """
    ...
    if path.exists(folder) == True:
        if dpi != None:
            plt.savefig('%s.png' % path_to_file, dpi=dpi)
        else:
