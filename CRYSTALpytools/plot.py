...
def plot_phonon_band(bands, unit='cm-1', k_labels=None, mode='single',
    ...
    Args:
        bands (BandsBASE|list): Bands object generated by code:`CRYSTALpytools.crystal_io.Crystal_output.read_pband`.
            Or a list of BandsBASE objects.
        unit (str): 'eV' or 'Hartree'
        k_labels (list): A list of high-symmetric k point labels. Greek
            alphabets should be, for example, 'Gamma'.
        mode (str): 'single'; 'multi': Overlap multiple band structures in
            the same figure; 'compare': Multiple band structures in different
            subfigures; 'surface': *In development*
        not_scaled (bool): Scale the x axis for different volumes.
        energy_range(array): 2\*1 array.
        k_range(array): 2\*1 array.
        ...
        title (str)
        figsize (list)
        scheme (list | tuple): Layout of subplots.
...
def plot_electron_band(bands, unit='eV', k_labels=None, mode='single',
    ...
    Args:
        bands (BandsBASE|list): Bands object generated by code:`CRYSTALpytools.crystal_io.Properties_output.read_bands`.
            Or a list of BandsBASE objects.
        unit (str): 'eV' or 'Hartree'
        k_labels (list): A list of high-symmetric k point labels. Greek
            alphabets should be, for example, 'Gamma'.
...
def plot_electron_banddos(bands, doss, unit='eV', k_labels=None, dos_beta='down',
                          ...
                          title=None, figsize=None, save_to_file=None):
    """
    A wrapper of plot_cry_es for electron band structure + dos. For spin-polarized
    cases, beta state 
    ...
    Args:
        ...
        k_labels (list): A list of high-symmetric k point labels. Greek
            alphabets should be, for example, 'Gamma'.
        dos_beta (str): 'Up' or 'down'. Plot beta stats on the same / other
            side of alpha state
        dos_prj (list): Index of selected projection. Consistent with the
            index of the 2nd dimension of :code:`doss.doss`
        energy_range (list): 2\*1 list of energy range
        dos_max_range (float): Maximum DOS range
        color_band (str): Color of plot bands.
        color_dos (str): Color of plot dos.
        labels (list): Plot legend.
        linestl_band (str): Band linestyle
        linestl_dos (str): DOS linestyle
        linewidth (float)
        fermi (str): Color of Fermi level line.
        title (str)
        figsize (list[float])
...
def plot_phonon_banddos(bands, doss, unit='cm-1', k_labels=None, dos_prj=None,
                        ...
                        title=None, figsize=None, save_to_file=None):
    """
    A wrapper of plot_cry_es for phonon band structure + dos. Only one pair is
    permitted.
    ...
    Args:
        ...
        dos_prj (list): Index of selected projection. Consistent with the
            index of the 2nd dimension of :code:`doss.doss`
        freq_range (list): 2\*1 list of frequency range
        dos_max_range (float): Maximum DOS range
        color_band (str): Color of plot bands.
        color_dos (str): Color of plot dos.
        labels (list): Plot legend.
        ...
        linestl_dos (str): DOS linestyle
        linewidth (float)
        freq0_line (str): Color of frequency=0 line
        title (str)
        figsize (list[float])
        save_to_file (str): File name.
    """
...
def save_plot(path_to_file, format='png'):
    """
    Save the plot as file. Not an individual method.
    """
    from os import path
    import warnings
    import matplotlib.pyplot as plt
